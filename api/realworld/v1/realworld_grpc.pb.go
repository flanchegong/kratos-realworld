...
type RealWorldClient interface {
	...
	AddComments(ctx context.Context, in *AddCommentRequest, opts ...grpc.CallOption) (*SingleCommentReply, error)
	GetComments(ctx context.Context, in *GetCommentRequest, opts ...grpc.CallOption) (*MultipleCommentReply, error)
...
func (c *realWorldClient) AddComments(ctx context.Context, in *AddCommentRequest, opts ...grpc.CallOption) (*SingleCommentReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *realWorldClient) GetComments(ctx context.Context, in *GetCommentRequest, opts ...grpc.CallOption) (*MultipleCommentReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type RealWorldServer interface {
	...
	AddComments(context.Context, *AddCommentRequest) (*SingleCommentReply, error)
	GetComments(context.Context, *GetCommentRequest) (*MultipleCommentReply, error)
...
func (UnimplementedRealWorldServer) AddComments(context.Context, *AddCommentRequest) (*SingleCommentReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddComments not implemented")
}
func (UnimplementedRealWorldServer) GetComments(context.Context, *GetCommentRequest) (*MultipleCommentReply, error) {
...
func _RealWorld_AddComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RealWorldServer).AddComments(ctx, req.(*AddCommentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
