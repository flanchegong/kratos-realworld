...
func _RealWorld_AddComments0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AddComments(ctx, req.(*AddCommentRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
type RealWorldHTTPClient interface {
	AddComments(ctx context.Context, req *AddCommentRequest, opts ...http.CallOption) (rsp *SingleCommentReply, err error)
	...
	GetComments(ctx context.Context, req *GetCommentRequest, opts ...http.CallOption) (rsp *MultipleCommentReply, err error)
...
func (c *RealWorldHTTPClientImpl) AddComments(ctx context.Context, in *AddCommentRequest, opts ...http.CallOption) (*SingleCommentReply, error) {
...
func (c *RealWorldHTTPClientImpl) GetComments(ctx context.Context, in *GetCommentRequest, opts ...http.CallOption) (*MultipleCommentReply, error) {
